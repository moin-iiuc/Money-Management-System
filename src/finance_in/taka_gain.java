 ...
 * @author DELL
 */
public class taka_gain extends javax.swing.JFrame {
     Connection connection=null;
    PreparedStatement statement=null;

    /**
     * Creates new form taka_gain
     */
    public taka_gain() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            JOptionPane.showMessageDialog(null,"Credit Added Succesfully");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(taka_gain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
